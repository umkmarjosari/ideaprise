...
# # CRUD kategori
    ...
    path('update_kategori/<int:id>/', views.update_kategori,name='update_kategori'),
    path('delete_kategori/<int:id>/', views.delete_kategori,name='delete_kategori'),
...
# # CRUD produk
    ...
    path('delete_produk/<int:id>/', views.delete_produk,name='delete_produk'),
# # CRUD kegiatan
    ...
    path('delete_kegiatan/<int:id>/', views.delete_kegiatan,name='delete_kegiatan'),
# # CRUD bundling
    path('create_bundling', views.create_bundling, name='create_bundling'),
    path('read_bundling', views.read_bundling,name='read_bundling'),
    path('read_detailbundling/<int:id>/', views.read_detailbundling,name='read_detailbundling'),
    path('update_bundling/<int:id>/', views.update_bundling,name='update_bundling'),
    path('delete_bundling/<int:id>/', views.delete_bundling,name='delete_bundling'),
]